  ...
  'web-apps': [
    {
      ...
      key: 'punchliner',
      title: 'Punchliner',
      img: `${GITHUB_PROJECTS_BASE_URL}/punchliner/punchliner_thumbnail.webp`,
      ...
      technologies: [
        ...
        { id: 'supabase', name: 'Supabase', link: 'https://sass-lang.com/', img: `${GITHUB_PROJECTS_BASE_URL}/techs/supabase.webp` },
      ],
      description: [
